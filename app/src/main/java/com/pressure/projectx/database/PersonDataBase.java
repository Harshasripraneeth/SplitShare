package com.pressure.projectx.database;
...
import com.pressure.projectx.Mate;
...
public class PersonDataBase {
    ...
    public long createEntry(String name,String purpose, String amount)
    {
        ContentValues contentValues = new ContentValues();
        contentValues.put(KEY_NAME4,name);
        contentValues.put(KEY_TEL4,purpose);
        contentValues.put(KEY_AMOUNT4, amount);
        return ourdatabase.insert(DATABASE_TABLE4,null,contentValues);
    }
